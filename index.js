...
function domloaded() {
    ...
    var elembuttonStandalone= document.getElementById("buttonStandalone");
    //https://developer.mozilla.org/en-US/docs/Web/API/Element/innerHTML
    elembuttonStandalone.addEventListener("mousedown", logEvent);

    //https://www.w3schools.com/howto/howto_js_animate.asp
    //var elem = document.getElementById("cptid");
    ...
    var cpt2=0;
    while (cpt2 < pointsArray.length) {
	console.log("while=" + cpt2);
	cpt2++;
    }
    ctx1.beginPath();
    ctx1.moveTo(100, 0);
	...
	document.getElementById("cptid").innerHTML = "cptcomptor";
	console.log("cpt="+cpt);

    }
    	console.log("FIN js interactif");
...
function drawArrayOn(arr, ctx1) {
    s = arr.length;
    //from part = left of segments : index-1... s-1
    if (s >= 1) {
	/**2=line : */
	if (s >= 2) {
